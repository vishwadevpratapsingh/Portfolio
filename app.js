...
for(let i=0; i<365;i++){
    ...
    const list=[
        ...
        259, 55, 56, 96, 97, 137, 138, 178, 179, 219, 220, 260, 261, 217, 177, 218, 259, 
...
window.addEventListener("scroll", ()=>{
    ...
    saluteTextContainer.style.transform= `translate(${offsetY * 0.1}px)`
    saluteImgContainer.style.transform= `translate(${offsetY * 0.4}px, ${offsetY * 0.7}px)`
    Authorname.style.transform= `translate(${offsetY * 0.2}px)`
